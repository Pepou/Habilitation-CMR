...
class Ui_Gestion_CMR(object):
    def setupUi(self, Gestion_CMR):
        ...
        self.comboBox_selet_cmr = QtGui.QComboBox(self.tab_3)
        self.comboBox_selet_cmr.setObjectName(_fromUtf8("comboBox_selet_cmr"))
        self.horizontalLayout_5.addWidget(self.comboBox_selet_cmr)
        ...
        self.lineEdit_nom_2 = QtGui.QLineEdit(self.tab_3)
        self.lineEdit_nom_2.setObjectName(_fromUtf8("lineEdit_nom_2"))
        self.verticalLayout_6.addWidget(self.lineEdit_nom_2)
        self.label_14 = QtGui.QLabel(self.tab_3)
        self.label_14.setObjectName(_fromUtf8("label_14"))
        self.verticalLayout_6.addWidget(self.label_14)
        self.lineEdit_prenom_2 = QtGui.QLineEdit(self.tab_3)
        self.lineEdit_prenom_2.setObjectName(_fromUtf8("lineEdit_prenom_2"))
        self.verticalLayout_6.addWidget(self.lineEdit_prenom_2)
        ...
        spacerItem2 = QtGui.QSpacerItem(769, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Gestion_CMR):
        ...
        self.label_15.setText(_translate("Gestion_CMR", "CHOIX CMR", None))
        ...
        self.label_8.setText(_translate("Gestion_CMR", "NOM", None))
        self.label_14.setText(_translate("Gestion_CMR", "PRENOM", None))
        self.label_10.setText(_translate("Gestion_CMR", "COURRIEL", None))
        self.label_11.setText(_translate("Gestion_CMR", "FONCTION", None))
        self.pushButton_3.setText(_translate("Gestion_CMR", "Modifier", None))
        self.pushButton_4.setText(_translate("Gestion_CMR", "Annuler", None))
